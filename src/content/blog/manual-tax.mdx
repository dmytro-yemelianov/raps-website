...
<PerformanceChart 
  title="Time Per Model Upload"
  subtitle="Active developer time spent on manual vs automated tasks"
  data={[
    { label: "Manual Process", value: 45, suffix: " min", color: "bg-gradient-to-r from-red-500 to-rose-600" },
    { label: "RAPS Automated", value: 1, suffix: " min", color: "bg-gradient-to-r from-emerald-400 to-emerald-600" }
  ]}
/>
