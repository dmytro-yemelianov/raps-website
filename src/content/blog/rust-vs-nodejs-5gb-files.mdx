...
<--- Last few GCs --->
[12345:0x5555556] 180234 ms: Mark-Sweep 8142.1 (8192.0) -> 8140.2 (8192.0) MB, 1247.3 / 0.0 ms allocation failure GC in old space requested
[12345:0x5555556] 181567 ms: Mark-Sweep 8142.8 (8192.0) -> 8141.1 (8192.0) MB, 1312.4 / 0.0 ms allocation failure GC in old space requested
...
**Result:** Processed the stream in **14 seconds** using constant memory (<100MB).
...
# Uses <200MB RAM regardless of input size
```
