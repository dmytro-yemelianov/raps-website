...
<PerformanceChart 
  title="Memory Usage (1GB Metadata)"
  subtitle="RAPS maintains constant memory while Node.js scales with file size"
  data={[
    { label: "Node.js (In-Memory)", value: 2500, suffix: " MB", color: "bg-gradient-to-r from-red-500 to-rose-600" },
    { label: "Node.js (Streaming)", value: 300, suffix: " MB", color: "bg-gradient-to-r from-orange-400 to-orange-600" },
    { label: "RAPS (Rust)", value: 100, suffix: " MB", color: "bg-gradient-to-r from-emerald-400 to-emerald-600" }
  ]}
/>
...
<PerformanceChart 
  ...
  subtitle="Seconds to filter Revit metadata (lower is better)"
  data={[
    { label: "Node.js (500MB)", value: 45, suffix: "s", color: "bg-gradient-to-r from-amber-400 to-amber-600" },
    { label: "RAPS (500MB)", value: 3, suffix: "s", color: "bg-gradient-to-r from-emerald-400 to-emerald-600" },
    { label: "Node.js (1.8GB)", value: 120, suffix: "s", color: "bg-gradient-to-r from-amber-400 to-amber-600" },
    { label: "RAPS (1.8GB)", value: 12, suffix: "s", color: "bg-gradient-to-r from-emerald-400 to-emerald-600" }
  ]}
/>
