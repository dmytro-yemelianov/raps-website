...
That's it. The CLI is now an MCP server, exposing **101 tools** for AI assistants.
...
2. **95+ commands** across 15 APIs—probably covers what you need
...
5. **MCP is real**—101 tools, works today, not a demo
