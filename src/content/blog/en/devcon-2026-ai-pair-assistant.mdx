...
1. You start an MCP server (in our case, `raps mcp`)
...
## The 101 Tools We've Built

The raps MCP server exposes **111 tools** covering comprehensive APS operations:
...
1. **MCP enables AI assistants to safely interact with APS APIs** via 101 specialized tools
