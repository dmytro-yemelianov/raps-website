...
<div class="not-prose my-8">
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
    <div class="bg-slate-800/50 rounded-lg border border-blue-500/30 p-4">
      <div class="text-blue-400 text-xs font-semibold uppercase tracking-wider mb-3">Asset Library</div>
      <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">3D Models</div>
    </div>
    <div class="bg-slate-800/50 rounded-lg border border-purple-500/30 p-4">
      <div class="text-purple-400 text-xs font-semibold uppercase tracking-wider mb-3">Processing</div>
      <div class="space-y-2">
        ...
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Extract Metadata</div>
      </div>
    </div>
    <div class="bg-slate-800/50 rounded-lg border border-purple-500/30 p-4">
      <div class="text-purple-400 text-xs font-semibold uppercase tracking-wider mb-3">Catalog Generation</div>
      <div class="space-y-2">
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Create Index</div>
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Build Grid View</div>
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Add Search</div>
      </div>
    </div>
    <div class="bg-slate-800/50 rounded-lg border border-emerald-500/30 p-4">
      ...
      <div class="space-y-2">
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">HTML Gallery</div>
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">JSON API</div>
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Static Site</div>
      </div>
    </div>
  </div>
</div>
...
<div class="not-prose my-6">
  <div class="flex flex-col sm:flex-row items-stretch gap-3">
    <div class="flex-1 bg-slate-800/50 rounded-lg border border-blue-500/30 p-3">
      <div class="text-blue-400 text-xs font-semibold uppercase tracking-wider mb-2">Daily 3 AM</div>
      <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Schedule</div>
    </div>
    ...
    <div class="flex-1 bg-slate-800/50 rounded-lg border border-purple-500/30 p-3">
      <div class="text-purple-400 text-xs font-semibold uppercase tracking-wider mb-2">Generation</div>
      <div class="space-y-1">
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">List Assets</div>
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Generate Thumbnails</div>
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Extract Metadata</div>
        <div class="bg-slate-900/50 rounded px-3 py-2 text-sm text-slate-300">Build HTML</div>
      </div>
    </div>
    <div class="hidden sm:flex items-center text-slate-600">→</div>
    <div class="flex-1 bg-slate-800/50 rounded-lg border border-emerald-500/30 p-3">
      <div class="text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-2">Deploy</div>
  ...
  <div class="bg-slate-900/50 rounded-lg border border-slate-700 p-4">
    ...
    <div class="space-y-2 text-sm">
      <div class="flex items-center gap-2">
        ...
        <span class="text-slate-400 ml-2">Generate asset catalog</span>
      </div>
      <div class="flex items-center gap-2">
        <span class="text-purple-400">AI</span>
        <span class="text-slate-500">→</span>
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-slate-400 ml-2">List objects</span>
      </div>
      <div class="flex items-center gap-2">
        <span class="text-amber-400">APS</span>
        <span class="text-slate-500">←</span>
        <span class="text-emerald-400">MCP</span>
        <span class="text-slate-400 ml-2">Object list</span>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-slate-500">→</span>
        <span class="text-purple-400">AI</span>
        <span class="text-slate-400 ml-2">Generate HTML gallery</span>
      </div>
      <div class="flex items-center gap-2">
        <span class="text-purple-400">AI</span>
        <span class="text-slate-500">→</span>
        <span class="text-blue-400">User</span>
        <span class="text-slate-400 ml-2">Catalog ready</span>
      </div>
    </div>
  </div>
</div>
