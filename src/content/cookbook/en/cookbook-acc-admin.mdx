...
raps admin folder rights "contractor@partner.com" --account "$ACCOUNT_ID" \
  --level view-download-upload-edit --folder project-files

# Grant view access to Plans folder
raps admin folder rights "reviewer@client.com" --account "$ACCOUNT_ID" \
  --level view-download --folder plans

# Custom folder by ID
raps admin folder rights "user@company.com" --account "$ACCOUNT_ID" \
