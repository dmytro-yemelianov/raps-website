...
The RAPS MCP (Model Context Protocol) server exposes 105 tools across 12 modules, letting AI assistants like Claude Desktop, Cursor, and VS Code Copilot interact with the Autodesk Platform Services APIs through natural language. Instead of memorizing CLI flags or API endpoints, you describe what you want and the AI calls the right RAPS tools automatically.
...
<div className="not-prose mb-8">
  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
    ...
    <div className="bg-purple-900/20 border border-purple-700/50 rounded-lg p-4 text-center">
      ...
      <div className="text-sm text-gray-400">105 Tools / 12 Modules</div>
    </div>
    <div className="text-2xl text-gray-500">&#8596;</div>
...
|--------|-------|-------------|
| `auth` | 4 | Token management, status, scopes |
| `oss` | 8 | Bucket and object operations |
| `dm` | 10 | Data Management hubs, projects, folders |
| `translate` | 6 | Model Derivative translations |
| `derivative` | 7 | Metadata, viewables, thumbnails |
| `acc` | 18 | ACC projects, issues, RFIs, forms |
| `admin` | 12 | Account admin, users, companies |
| `pipeline` | 6 | Pipeline execution and status |
| `webhook` | 5 | Webhook management |
| `reality` | 4 | Reality capture photo scenes |
| `cost` | 8 | Cost management budgets, contracts |
| `mock` | 17 | Local mock server for testing |
...
The AI should respond with the full list of 105 tools grouped by module. If it reports that the RAPS server is not connected, check your configuration paths and ensure the `raps` binary is on your system PATH.
