...
2. **Set continue_on_error wisely** — Only for non-critical steps
3. **Use dry-run first** — Validate before executing
4. **Store secrets in environment** — Never in pipeline files
5. **Use retry for network operations** — APIs can have transient failures
