...
After registering, copy the **Account ID** shown on the Custom Integrations page — it's the UUID listed next to your account name (e.g. `01fb1602-2ec0-4b05-bf6e-39dc70b3ae05`).
...
| `raps admin folder set-permissions` | Set folder permissions in bulk |
