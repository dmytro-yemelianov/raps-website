...
## UX Improvements (v4.5)

### Enhanced Error Messages

API errors now include actionable context with suggested fixes:
...
- Array results render as column-aligned tables with headers
- Single objects render as key-value pairs for readability
- Unicode box-drawing characters for cleaner visual output

## Related Documentation

- [Configuration](/docs/configuration) — Detailed configuration options
- [Authentication](/docs/auth) — Auth commands and flows
- [Exit Codes](/docs/exit-codes) — Complete exit code reference
